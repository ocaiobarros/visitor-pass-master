-- Report RPCs, view access_events_enriched e índices de performance
-- Criadas para suportar o módulo de relatórios táticos e executivos.

-- ============================================================
-- VIEW: access_events_enriched
-- ============================================================
...
-- Grants para RPCs
-- ============================================================
GRANT SELECT ON public.access_events_enriched TO anon, authenticated, service_role;
