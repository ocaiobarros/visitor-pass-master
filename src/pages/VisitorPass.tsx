...
const VisitorPass = () => {
  ...
  return (
    <DashboardLayout>
      ...
      {/* ========================================= */}
      {/* PRINT-ONLY: Exact WYSIWYG copy of screen preview */}
      {/* Uses same Card layout as screen for 100% fidelity */}
      {/* ========================================= */}
      <div className="hidden print:block print:pt-8" id="print-area">
        <Card className="max-w-2xl mx-auto p-8 bg-white border border-border shadow-none">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-border pb-6 mb-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-xl bg-primary flex items-center justify-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            {/* Photo & QR */}
            <div className="space-y-4">
              <div className="w-full rounded-xl bg-muted border border-border flex items-center justify-center overflow-hidden" style={{ aspectRatio: '1/1' }}>
                {visitor.photoUrl ? (
                  <img 
                    src={visitor.photoUrl} 
                    alt={visitor.fullName} 
