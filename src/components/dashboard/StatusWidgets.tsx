...
import { Users, Shield, DoorOpen, UserCog, Car, UsersRound } from 'lucide-react';
      ...
      <Card className="bg-gradient-to-br from-warning/10 to-warning/5 border-warning/20">
        <CardContent className="pt-4 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground font-medium">Agregados</p>
              <p className="text-xl font-bold text-warning">{associatesActive}</p>
              <p className="text-xs text-muted-foreground">Ativos</p>
            </div>
          </div>
        </CardContent>
