 ...
 *   # ou
 *   docker compose run --rm e2e npx ts-node /e2e/scripts/seed-admin.ts
 * 
 * Comportamento:
 *   - Cria admin se não existir
 *   - Confirma email se não confirmado
 *   - Reseta senha se divergir
 *   - UPSERT role admin em user_roles
 *   - UPSERT profile com is_active=true
 * 
 * Idempotência: rodar 10x seguidas = mesmo resultado
 * ============================================
 */
